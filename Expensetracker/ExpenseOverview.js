      ...
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        ...
        <div style={{ margin: '20px 20px 20px 30px' }}>
          <Typography variant="h5" className={classes.spent} color="primary">
            ₹{expensePreview.today ? expensePreview.today.totalSpent : '0'} <span className={classes.day}>today</span>
          </Typography>
          <Typography variant="h5" className={classes.spent} color="primary">
            ₹{expensePreview.yesterday ? expensePreview.yesterday.totalSpent : '0'} <span className={classes.day}>yesterday</span>
          </Typography>
        ...
        {expenseCategories.map((expense, index) => (
          <div key={index} style={{ display: 'grid', justifyContent: 'center' }}>
            ...
            <div>
              ...
              <Typography component="span" className={`${classes.catHeading} ${classes.val}`}>
                {expense.mergedValues.total && expense.mergedValues.total - expense.mergedValues.average > 0 ? "spent extra" : "saved"}
              </Typography>
            </div>
            <div style={{ marginBottom: 3 }}>
              ...
              <Typography component="span" className={classes.val} style={{ color: '#002f6c', fontSize: '1.6em', backgroundColor: '#eafff5', padding: '8px 0' }}>₹{expense.mergedValues.total || 0}</Typography>
            ...
            <Typography component="span" className={classes.day} style={{ color: '#4f83cc', marginTop: 5 }}>
              Payment Type: {expense.paymentType || "N/A"}
            </Typography>
